...
import { searchEntities, getEntities } from './wait-list.reducer';
  ...
  return (
    <div>
      <h2 id="wait-list-heading" data-cy="WaitListHeading">
        <Translate contentKey="systemLibraryApp.waitList.home.title">Wait Lists</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="systemLibraryApp.waitList.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/wait-list/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="systemLibraryApp.waitList.home.createLabel">Create new Wait List</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('systemLibraryApp.waitList.home.search')}
                />
        ...
        {waitListList && waitListList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="systemLibraryApp.waitList.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('creatAt')}>
                  <Translate contentKey="systemLibraryApp.waitList.creatAt">Creat At</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="systemLibraryApp.waitList.patronAccount">Patron Account</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="systemLibraryApp.waitList.book">Book</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="systemLibraryApp.waitList.home.notFound">No Wait Lists found</Translate>
            </div>
          )
        )}
      </div>
