...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="systemLibraryApp.notification.delete.question">
        <Translate contentKey="systemLibraryApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
