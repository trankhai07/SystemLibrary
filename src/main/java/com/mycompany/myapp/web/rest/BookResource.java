...
public class BookResource {
     ...
     */
    @PostMapping("/books")
    public ResponseEntity<Book> createBook(@Valid @RequestBody Book book) throws URISyntaxException, BadRequestException {
    ...
    public ResponseEntity<List<Book>> getAllBooksByCategory(
        @org.springdoc.api.annotations.ParameterObject Pageable pageable,
        @RequestParam(required = false, defaultValue = "false") boolean eagerload,
    ...
    public ResponseEntity<Void> deleteBook(@PathVariable Long id) throws BadRequestException {
